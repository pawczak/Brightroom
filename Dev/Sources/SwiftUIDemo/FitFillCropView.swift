...
struct FitFillCropView: View {
  ...
  var body: some View {
    ZStack {
      ...
      VStack {
        PhotosCropRotating(editingStack: { editingStack }, cropExtension: CGSize(width: 100, height: 100))
//        Button("Done") {
...
//        }
      ...
      VStack {
        HStack {
//          Button("Change Image") {
//            editingStack.changeImage(newImage: Mocks.imageHorizontal())
//          }
